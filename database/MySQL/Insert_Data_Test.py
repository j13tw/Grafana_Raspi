...
try:
    ...
    cur.execute('INSERT INTO ET7044 \
                ...
                VALUE \
                ("' + str(time_stamp) + '", False, False, False, False, True, False, False, False);')
    conn.commit()
...
try:
    ...
    cur.execute('INSERT INTO Power_Box_A \
                ...
                VALUE \
                ("' + str(time_stamp) + '", 11.2, 10.3, 16.5, 20.3, 15.5, 20.5, 13.5);')
    conn.commit()
...
try:
    ...
    cur.execute('INSERT INTO Power_Box_B \
                (Time_Stamp, In_A, In_B, Out_A, Out_B, Out_C, Out_D, Out_E) \
                VALUE \
                ("' + str(time_stamp) + '", 12.2, 11.3, 14.5, 21.3, 15.4, 21.5, 12.5);')
    conn.commit()
...
try:
    ...
    cur.execute('INSERT INTO UPS_A \
                ...
                VALUE \
                ("' + str(time_stamp) + '", "/dev/ttyUSB0 (牆壁)", "onLine(在線)", "Normal", \
                1, 59.9, 215,\
...
try:
    ...
    cur.execute('INSERT INTO UPS_B \
                ...
                Battery_Next_Change_Year, Battery_Next_Change_Mon, Battery_Next_Change_Day) \
                VALUE \
                ("' + str(time_stamp) + '", "/dev/ttyUSB1 (窗戶)", "onLine(在線)", "Normal", \
                1, 59.9, 215,\
                1, 60.0, 220, 16.2345, 4.567, 45, \
                271, 100, "Good (良好)", "OK (良好)", "Boost charging (快速充電)", 33, \
                2017, 03, 25, \
    ...
    print("UPS_B Table ERROR")

print("Try Insert Table Finsh !")
